...
[![PyPI version](https://img.shields.io/pypi/v/gosmsge.svg)](https://pypi.org/project/gosmsge/)
[![Python versions](https://img.shields.io/pypi/pyversions/gosmsge.svg)](https://pypi.org/project/gosmsge/)
...
- Added async client (`AsyncSMS`) via `pip install gosmsge[async]`
...
- PyPI: https://pypi.org/project/gosmsge/
